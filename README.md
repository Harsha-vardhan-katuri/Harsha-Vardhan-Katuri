...
## � Experience
- **Firmware Engineer** (Current): Developing firmware for medical and IoT devices, focusing on sensor interfacing, BLE communication, and embedded C/C++.
- **Internships & Projects**: Worked on ESP32/ESP8266, Arduino, LPC2148-based projects, including BLE/LoRa implementations and sensor integration.
...
## 🚀 Featured Projects
- **[IoT Sensor Hub](https://github.com/Harsha-vardhan-katuri/iot-sensor-hub)**: Firmware for ESP32-based IoT device with sensor integration and BLE communication.
- **[BLE Beacon Project](https://github.com/Harsha-vardhan-katuri/ble-beacon)**: Implementation of BLE beacons using Arduino and LPC2148 for proximity detection.
- **[Embedded Linux Driver](https://github.com/Harsha-vardhan-katuri/linux-driver)**: Custom Linux device driver for hardware interfacing.
